      ...
      <div className=" flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5">
        ...
        <div className="flex-1">
          ...
          <p className='text-sm mt-5'>
            this is a demo project, I may change it later.
          </p>
        </div>
        ...
        <div className="flex-1">
          <form className='flex flex-col gap-4'>
            ...
            {/* Sign Up Button */}
            <Button className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg text-white w-full' type='submit'>
              Sign Up
            </Button>
          </form>
